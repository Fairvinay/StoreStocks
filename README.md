...
The actual project working local is D:\n\groww-task
this has 2 parts 
1. the Next JS local UI that runs on the https://192.168.1.7:3000 as of July 11 2025 the IP of the machine is 192.168.1.7
2. verify the IP mentioned in the https://myapi.fyers.in/dashboard  MoneyFlow this is created for Local App Call Back 
3. the ip for the call back is https://192.168.1.7:8888/.netlify/functions/netlifystockfyersbridge/api/fyerscallback as 
      of Updated : Updated date 15 Jun 2025 with following details and Permissions 
	App type: User App  	Webhook count:0 	App ID:TRLV2A6GPL-100
        Secret ID:V72MPISUJC	
	Permissions:
